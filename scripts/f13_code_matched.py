"""Code the MASS-MATCHED draw with the v6 instrument (intensity restored).

THE TEST: within a prompt, faller held fixed, is the word that GAINED mass
judged B_MILDER more often than a mass-matched co-present word that did NOT
gain? Paired by (prompt, edge, faller). Primary population = ACT and RESULT
slots only; REF/NARR/SENSE/UTTER are coded and expected to be NOT_COMPARABLE,
which is a validation check on the field rather than a result.
...
SRC = "data/f13_matched_items.parquet"
