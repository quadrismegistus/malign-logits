...
- **"Safety-targeted preference training is content-selective" — REFUTED BY
  ...
  to produce. UNDER RE-EXAMINATION per [1027]: the independent two-seat pass places the safety pair strongest (amber 6.33, beaver 4.26, next at 1.86) — this entry does not un-retire until the population/quantity questions resolve, and the general claim does not quote either. Confound sentence that would have travelled with any
