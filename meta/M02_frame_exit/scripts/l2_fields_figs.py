    ...
    p = (
        ...
        + labs(
            ...
            subtitle=(
                ...
                "field whose signature is real on the left and not contradiction-specific on the "
                "right.\n"
                ...
                "median of differences is not a difference of medians. Measured: they disagree in 79 "
                "of 79 fields, median absolute discrepancy 0.000911, the same order as the effects.\n"
                "BOTH PANELS SHARE ONE AXIS, so the residual's collapse toward zero is measured against "
                "the effect beside it rather than rescaled to fill its own panel.\n"
