...
date: 2026-07-27
role: finding
verification: "RE-VERIFIED 2026-07-27 against frozen final history (HEAD 5c4fa09; pinned at f4b7810, an ancestor -- appends do not orphan). All 18 commit citations in findings/ and docs/ resolve and are ancestors; see docs/citation_inventory.md and scripts/verify_citations.py. History of the defect: the original 2026-07-27 audit pass rested in part on a FABRICATED commit citation for the phrase committed before running; the real commit is 2b58732 and the fabrication is disclosed on the finding face. ONE RESIDUAL, stated because re-verification does not erase it: the ORDERING property of that citation -- that the commit precedes the run -- was corroborated forensically by lacan on the morning of 2026-07-27 (gate-artifact mtime in the same second as the commit author date), and that artifact was subsequently overwritten by re-runs during provenance development. The ordering claim is therefore supported TESTIMONIALLY where it was once FORENSIC. Runs from c52df58 forward embed provenance in their own output so the record travels with the artifact."
