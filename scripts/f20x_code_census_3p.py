"""Code the THIRD-PERSON battery. Matched prompts only -- the primary comparison
registered in Amendment 7. The he/they variants are coded separately and are
never pooled into the difference-of-differences.
    ...
    for s in range(0,len(todo),CHUNK):
        ...
        for r,a in zip(blk.itertuples(),anns):
            ...
            rows.append(dict(family=r.family, arm=r.arm, model_id=r.model_id,
                ...
                speaker_note=v["referent_note"], codes=json.dumps(v["codes"]),
