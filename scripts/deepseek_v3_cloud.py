...
def main():
    ...
    for model_id in MODELS:
        ...
        # Wipe the HF hub cache to make room for the next model — but ONLY on
        # a throwaway cloud box. Run locally this would delete every cached
        # model on the machine (hundreds of GB).
